...
export function ThroneArmrests({ tilt, currentFaction }) {
  return (
    ...
    >
      {/* Left Throne Armrest */}
      <div className="w-24 sm:w-48 h-16 sm:h-24 bg-gradient-to-t from-red-950 via-rose-900 to-amber-900/60 border-t-4 border-r-4 border-amber-600/70 rounded-tr-3xl shadow-[0_-10px_30px_rgba(0,0,0,0.8)] flex items-center justify-center relative">
