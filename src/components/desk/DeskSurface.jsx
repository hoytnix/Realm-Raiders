...
export function DeskSurface({
  ...
  return (
    <main className="relative z-10 flex-1 w-full max-w-6xl mx-auto flex items-center justify-center p-0 md:p-4 md:perspective-[1200px] h-full overflow-hidden">
      {/* The Heavy Iron-Banded Oak Desk Surface (Collapses on Mobile) */}
      <div
        className="relative w-full h-full md:h-[82vh] md:max-h-[680px] bg-[#1c120c] md:bg-[#221710] border-0 md:border-4 md:border-[#3e271c] rounded-none md:rounded-3xl shadow-none md:shadow-[0_25px_60px_rgba(0,0,0,0.9),inset_0_2px_15px_rgba(255,255,255,0.08)] flex items-center justify-center p-0 md:p-6 transition-transform duration-200 ease-out overflow-hidden"
        style={{
          transform: isMobile ? 'none' : `rotateX(${12 + tilt.y * 4}deg) rotateY(${tilt.x * 6}deg)`,
      ...
      >
        ...
        <div className="hidden md:block absolute top-8 left-8 w-44 h-44 rounded-full bg-radial from-amber-400/25 via-amber-700/10 to-transparent blur-xl pointer-events-none animate-pulse" />
        <div className="hidden md:block absolute bottom-10 right-8 w-48 h-48 rounded-full bg-radial from-amber-400/20 via-yellow-700/10 to-transparent blur-xl pointer-events-none animate-pulse" />
        ...
        {/* -------------------------------------------------------
            THE CENTRAL LIVING PARCHMENT SCROLL (Edge-to-edge on Mobile)
            ------------------------------------------------------- */}
        <div className="relative w-full h-full max-w-none md:max-w-4xl bg-[#f4ecd8] border-0 md:border-[6px] md:border-[#cbb38b] rounded-none md:rounded-2xl shadow-none md:shadow-[0_15px_40px_rgba(0,0,0,0.8),inset_0_0_30px_rgba(139,94,60,0.4)] text-stone-900 flex flex-col overflow-hidden pb-14 md:pb-0">
          {/* Brass Corner Weights (Desktop only) */}
          <div className="hidden md:block absolute top-1.5 left-1.5 w-6 h-6 rounded-full bg-gradient-to-br from-yellow-300 to-amber-700 border border-amber-900 shadow-md z-30" />
          <div className="hidden md:block absolute top-1.5 right-1.5 w-6 h-6 rounded-full bg-gradient-to-br from-yellow-300 to-amber-700 border border-amber-900 shadow-md z-30" />
          <div className="hidden md:block absolute bottom-1.5 left-1.5 w-6 h-6 rounded-full bg-gradient-to-br from-yellow-300 to-amber-700 border border-amber-900 shadow-md z-30" />
          <div className="hidden md:block absolute bottom-1.5 right-1.5 w-6 h-6 rounded-full bg-gradient-to-br from-yellow-300 to-amber-700 border border-amber-900 shadow-md z-30" />
